...
namespace PharmacyContracts.Modules.Claims.Application.Interfaces
{
    ...
    {
        Task<Result<ClaimReviewResponseDto>> CreateAsync(Guid claimId, Guid reviewerUserId, CreateClaimReviewRequestDto request, CancellationToken cancellationToken = default);
        ...
        Task<Result<ClaimReviewResponseDto>> GetByClaimIdAsync(Guid claimId, CancellationToken cancellationToken = default);
    }
}
